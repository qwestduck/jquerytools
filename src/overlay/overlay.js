...
/*global document, effects, jQuery, window*/
(function ($) {
    "use strict";
    // static constructs
    ...
    function Overlay(trigger, conf) {
        ...
        jq = conf.target || trigger.attr("rel");
        overlay = jq ? $(jq) : trigger;
        ...
        // callbacks	
        $.each(["onBeforeLoad", "onStart", "onLoad", "onBeforeClose", "onClose"], function (i, name) {
            // configuration
