 ...
 * Date: @DATE 
 */
/*global document, jQuery, setTimeout*/
(function ($) {
    "use strict";
    // static constructs
    ...
    function Scrollable(root, conf) {
        ...
        // circular loop
        if (conf.circular) {
            cloned1 = self.getItems().slice(-1).clone().prependTo(itemWrap);
            ...
            hidden_parents = root.parents().add(root).filter(function () {
        ...
        // next/prev buttons
        prev = find(root, conf.prev).click(function (e) { e.stopPropagation(); self.prev(); });
