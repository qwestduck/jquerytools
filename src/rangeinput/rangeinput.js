...
(function ($) {
    ...
    */
    ...
    function RangeInput(input, conf) {
        ...
        $.each(["min", "max", "step", "value"], function (i, key) {
        ...
        /**
         * The flesh and bone of this tool. All sliding is routed through this.
         *
        ...
        // callbacks
        $.each(["onSlide", "change"], function (i, name) {
            // from configuration
    ...
    $.fn.rangeinput = function (conf) {
        ...
        this.each(function () {
            var el = new RangeInput($(this), $.extend(true, {}, conf)),
                input = el.getInput().data("rangeinput", el);
