 ...
 * Date: @DATE 
 */
/*global document, isType, jQuery, navigator, window*/
(function ($) {
    "use strict";
    ...
    function getPosition(trigger, el, conf) {
        ...
        top = top - el.outerHeight() - conf.offset[0];
        left = left + trigger.outerWidth() + conf.offset[1];
        ...
        // adjust Y		
        height = el.outerHeight() + trigger.outerHeight();
        if (y === 'center') {
            top = top + height / 2;
        } else if (y === 'bottom') {
            top = top + height;
        ...
        if (x === 'center') {
            left = left - (width + el.outerWidth()) / 2;
        } else if (x === 'left') {
            left = left - width;
        }
        ...
        'default' : [
            ...
            function (errs) {
                ...
                $.each(errs, function (i, err) {
                    ...
                    pos = getPosition(input, msg, conf);
    ...
    */
    ...
    function Validator(inputs, form, conf) {
        ...
        // callbacks	
        $.each(["onBeforeValidate", "onBeforeFail", "onFail", "onSuccess"], function (i, name) {
            // configuration
