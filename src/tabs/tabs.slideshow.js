 ...
 * Date: @DATE 
 */
/*global clearTimeout, setTimeout, jQuery*/
(function ($) {
    "use strict";
    var tool;
    ...
    function Slideshow(root, conf) {
        ...
        nextButton = find(conf.next).click(function () {
            tabs.next();
        });

        prevButton = find(conf.prev).click(function () {
            tabs.prev();
        });
        ...
        // callbacks	
        $.each(["onBeforePlay", "onPlay", "onBeforePause", "onPause"], function (i, name) {
            // configuration
